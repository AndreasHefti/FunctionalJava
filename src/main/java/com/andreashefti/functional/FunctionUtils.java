...
public abstract class FunctionUtils {
    ...
    public static abstract class Collection {
        ...
        static <T> List<T> prependFoldLeft( final List<T> list, final T value ) {
            return foldLeft( list, list( value ), a -> b -> append( a, b ) );
        }
        ...
        static <T> List<T> reverseFoldLeft( final List<T> list ) {
            return foldLeft( list, list(), x -> y -> foldLeft( x, list( y ), ( List<T> a) -> ( T b ) -> append( a, b ) ) );
        }
         ...
         */
        public static <T, U> U foldLeft( final List<T> list, final U identity, final Function<U, Function<T, U>> f ) {
            return foldLeftImperative( list, identity, f );
        }
